...
function sendEmail($email,$subject,$content){
    ...
    try {
        ...
        $mail->Username   = 'hoquoctri10b7@gmail.com';                     //SMTP username
        $mail->Password   = 'lpedfuxdlkvahszd';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port       = 465;                                    //TCP port to connect to; use 465 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
        //Recipients
        $mail->setFrom('hoquoctri10b7@gmail.com', $email);   //Add a recipient
        $mail->addAddress('hoquoctri10b7@gmail.com');               //Name is optional
